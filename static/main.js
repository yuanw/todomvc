...
(function($PS) {
                              ...
                              if (v1 instanceof Data_Either.Right) {
                                  return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("loaded"))(function () {
                                      return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                          ...
                                          $35.loading = false;
                                          $35.scientists = v1.value0;
                                          return $35;
                                      });
                                  });
                              };
                              throw new Error("Failed pattern match at Main (line 113, column 11 - line 119, column 61): " + [ v1.constructor.name ]);
                          };
                          throw new Error("Failed pattern match at Main (line 108, column 7 - line 119, column 61): " + [ res.constructor.name ]);
                      });
                  });
              });
          };
          throw new Error("Failed pattern match at Main (line 97, column 16 - line 119, column 61): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      var render = function (state) {
          ...
          }) ])([ Halogen_HTML_Core.text("+") ]) ]), Halogen_HTML_Elements.form([ Halogen_HTML_Events.onSubmit(function (ev) {
              return new MakeRequest(ev);
          }) ])([ Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("Look up Scientists") ]), Halogen_HTML_Elements.button([ Halogen_HTML_Properties.disabled(state.loading), Halogen_HTML_Properties.type_(Halogen_HTML_Core.isPropButtonType)(DOM_HTML_Indexed_ButtonType.ButtonSubmit.value) ])([ Halogen_HTML_Core.text("Fetch scientists") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (state.loading) {
                  return "Working...";
              };
              return "";
