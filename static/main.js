...
(function($PS) {
  ...
  var isStringAlignContentValue = {
      fromString: (function () {
          var $95 = CSS_String.fromString(CSS_Property.isStringValue);
          return function ($96) {
              return AlignContentValue($95($96));
          };
      })()
  };
...
(function($PS) {
  ...
  var spaceEvenlyValue = {
      spaceEvenly: CSS_String.fromString(CSS_Property.isStringValue)("space-evenly")
  };
  var spaceEvenlyJustifyContentValue = {
      spaceEvenly: CSS_String.fromString(CSS_Flexbox.isStringJustifyContentValue)("space-evenly")
  };
  var spaceEvenlyAlignContentValue = {
      spaceEvenly: CSS_String.fromString(CSS_Flexbox.isStringAlignContentValue)("space-evenly")
  };
      ...
      return function (v) {
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.request({
                      ...
                      if (res instanceof Data_Either.Left) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Get /scientist error" + Affjax.printError(res.value0))))(function () {
                          ...
                          if (v1 instanceof Data_Either.Right) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("loaded"))(function () {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      ...
                                      $30.loading = false;
                                      $30.scientists = v1.value0;
                                      $30.currentScientist = Data_Array.head(v1.value0);
                                      return $30;
                                  });
                              });
                          };
          ...
          if (v instanceof Decrement) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $35.counter = s.counter - 1 | 0;
                  $35.currentScientist = Data_Array.index(s.scientists)(s.counter - 1 | 0);
                  return $35;
              });
          };
          if (v instanceof Increment) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $38.counter = s.counter + 1 | 0;
                  $38.currentScientist = Data_Array.index(s.scientists)(s.counter + 1 | 0);
                  return $38;
              });
          };
