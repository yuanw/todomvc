...
(function($PS) {
  ...
  var isStringAlignContentValue = new CSS_String.IsString((function () {
      var $90 = CSS_String.fromString(CSS_Property.isStringValue);
      return function ($91) {
          return AlignContentValue($90($91));
      };
  })());
  exports["isStringAlignContentValue"] = isStringAlignContentValue;
                  ...
                  return function (dictLacks) {
                      return new GDecodeJson(function (object) {
                          return function (v) {
                              ...
                              if (v1 instanceof Data_Maybe.Just) {
                                  return Control_Bind.bind(Data_Either.bindEither)(Data_Bifunctor.lmap(Data_Bifunctor.bifunctorEither)(Data_Argonaut_Decode_Error.AtKey.create(fieldName))(decodeJson(dictDecodeJson)(v1.value0)))(function (val) {
                              ...
                              throw new Error("Failed pattern match at Data.Argonaut.Decode.Class (line 126, column 5 - line 133, column 44): " + [ v1.constructor.name ]);
                          };
                      });
                  };
              };
...
(function($PS) {
  ...
  var spaceEvenlyValue = new SpaceEvenly(CSS_String.fromString(CSS_Property.isStringValue)("space-evenly"));
  ...
  var spaceEvenlyAlignContentValue = new SpaceEvenly(CSS_String.fromString(CSS_Flexbox.isStringAlignContentValue)("space-evenly"));
  var spaceEvenly = function (dict) {
      return dict.spaceEvenly;
  };
  var handleAction = function (dictMonadAff) {
      return function (v) {
          if (v instanceof Initialze) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(dictMonadAff))(Affjax.request({
                      ...
                      if (res instanceof Data_Either.Left) {
                          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))(Effect_Class_Console.log(Effect_Class.monadEffectEffect)("Get /scientist error")))(function () {
                      ...
                      if (res instanceof Data_Either.Right) {
                          ...
                          if (v1 instanceof Data_Either.Left) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("can't parse json: " + Data_Show.show(Data_Argonaut_Decode_Error.showJsonDecodeError)(v1.value0)))(function () {
                          ...
                          if (v1 instanceof Data_Either.Right) {
                              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class_Console.log(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadAff.MonadEffect0()))("loaded"))(function () {
                                  return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v2) {
                                      var $29 = {};
                                      for (var $30 in v2) {
                                      ...
                                      $29.loading = false;
                                      $29.scientists = v1.value0;
                                      $29.currentScientist = Data_Array.head(v1.value0);
                                      return $29;
                                  });
                              });
                          };
                          throw new Error("Failed pattern match at Main (line 105, column 11 - line 111, column 91): " + [ v1.constructor.name ]);
                      };
                      throw new Error("Failed pattern match at Main (line 100, column 7 - line 111, column 91): " + [ res.constructor.name ]);
                  });
              });
          };
          if (v instanceof Decrement) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $34.counter = s.counter - 1 | 0;
                  $34.currentScientist = Data_Array.index(s.scientists)(s.counter - 1 | 0);
                  return $34;
              });
          };
          if (v instanceof Increment) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
                  ...
                  $37.counter = s.counter + 1 | 0;
                  $37.currentScientist = Data_Array.index(s.scientists)(s.counter + 1 | 0);
                  return $37;
              });
          };
          throw new Error("Failed pattern match at Main (line 96, column 16 - line 119, column 81): " + [ v.constructor.name ]);
      };
  };
  var component = function (dictMonadAff) {
      var render = function (state) {
          return Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Decrement.value;
          }) ])([ Halogen_HTML_Core.text("-") ]), Halogen_HTML_Core.text(Data_Show.show(Data_Show.showInt)(state.counter)), Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
              return Increment.value;
          }) ])([ Halogen_HTML_Core.text("+") ]) ]), Halogen_HTML_Elements.h2_([ Halogen_HTML_Core.text("The Great Scientists") ]), Halogen_HTML_Elements.p_([ Halogen_HTML_Core.text((function () {
              if (state.loading) {
                  return "Working...";
              };
              return "";
          })()) ]), Halogen_HTML_Elements.div_((function () {
              if (state.currentScientist instanceof Data_Maybe.Nothing) {
                  return [  ];
              };
              if (state.currentScientist instanceof Data_Maybe.Just) {
                  return [ Halogen_HTML_Elements.div_([ Halogen_HTML_Elements.img([ Halogen_HTML_Properties.src(state.currentScientist.value0.sPhotoUrl) ]) ]), Halogen_HTML_Elements.div_([ Halogen_HTML_Core.text(state.currentScientist.value0.sName) ]) ];
              };
              throw new Error("Failed pattern match at Main (line 88, column 9 - line 92, column 42): " + [ state.currentScientist.constructor.name ]);
          })()) ]);
      };
      var initialState = function (v) {
          return {
              ...
              loading: false,
              scientists: [  ],
              currentScientist: Data_Maybe.Nothing.value
          };
      };
      return Halogen_Component.mkComponent({
          ...
          "eval": Halogen_Component.mkEval({
              ...
              initialize: new Data_Maybe.Just(Initialze.value),
  ...
  exports["spaceEvenlyValue"] = spaceEvenlyValue;
  exports["spaceEvenlyAlignContentValue"] = spaceEvenlyAlignContentValue;
