...
(function($PS) {
  ...
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div([ Halogen_HTML_CSS.style(Data_Semigroup.append(CSS_Stylesheet.semigroupCSS)(CSS_Display.display(CSS_Display.flex))(Data_Semigroup.append(CSS_Stylesheet.semigroupCSS)(CSS_Flexbox.flexDirection(CSS_Flexbox.row))(Data_Semigroup.append(CSS_Stylesheet.semigroupCSS)(CSS_Flexbox.justifyContent(spaceEvenly(spaceEvenlyJustifyContentValue)))(CSS_Geometry.width(CSS_Size.rem(6.0)))))) ])([ Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
      ...
      var handleAction = function (v) {
          ...
          throw new Error("Failed pattern match at Main (line 60, column 18 - line 65, column 36): " + [ v.constructor.name ]);
      };
